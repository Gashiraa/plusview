...
class QuotationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quotation" do
    assert_difference('Quotation.count') do
      post quotations_url, params: { quotation: { date: @quotation.date, status: @quotation.status, total: @quotation.total } }
    end
  ...
  test "should update quotation" do
    patch quotation_url(@quotation), params: { quotation: { date: @quotation.date, status: @quotation.status, total: @quotation.total } }
